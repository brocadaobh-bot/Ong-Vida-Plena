-- ============================================================
-- Migration 024: Estatísticas públicas + avaliações da plataforma
-- ============================================================
...
CREATE INDEX idx_platform_ratings_score ON platform_ratings(score);
...
-- Métricas agregadas para a página inicial (anon + autenticados)
